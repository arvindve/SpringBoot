...
public class FileService {
	...
	private String getFileExtention(String fileName) {
		...
		return fileName.substring(dotPosition + 1).toString();
	}

	private boolean isImageExtension(String extention) {

		String testExtension = extention.toLowerCase();
		for (String extn : imageExtentions.split(",")) {
			if (extn.equals(testExtension)) {
				return true;
			}
		}
		return false;
